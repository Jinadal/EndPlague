...
void FabricVillage::loadLevel()
{
    ...
    GameObject* map = GameResource::getInstance()->createGameObject(0.f, 0.f, -1.f, 0.f);
    RenderManager::getInstance()->createComponent(map, (char*)"res/IAMAPY.obj");//Fachada de render y path de obj
    ...
    GameObject* player = GameResource::getInstance()->createGameObject(0.f, 0.f, -2.f, 0.f);//Creates a new GO on x, y, z, rz
